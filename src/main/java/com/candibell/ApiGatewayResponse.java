...
public class ApiGatewayResponse {
	...
	public static ApiGatewayResponse missingMandatoryField(String msg) {
	...
	public static ApiGatewayResponse badField(String msg) {
		return ApiGatewayResponse.builder()
				.setStatusCode(400)
				.setObjectBody(msg)
				.setHeaders(Collections.singletonMap("X-Powered-By", "AWS Lambda & Serverless"))
	...
	public static ApiGatewayResponse unauthorized(Map<String, Object> input) {
		Response responseBody = new Response("Unauthorized", input);
		return ApiGatewayResponse.builder()
				.setStatusCode(401)
	...
	public static ApiGatewayResponse notFound(String msg) {
		return ApiGatewayResponse.builder()
				.setStatusCode(404)
				.setObjectBody(msg)
				.setHeaders(Collections.singletonMap("X-Powered-By", "AWS Lambda & Serverless"))
	...
	public static ApiGatewayResponse successNoBody() {
		return ApiGatewayResponse.builder()
				.setStatusCode(200)
				.setHeaders(Collections.singletonMap("X-Powered-By", "AWS Lambda & Serverless"))
				.build();
	...
	public static ApiGatewayResponse successWithBody(Object bodyObject) {
		return ApiGatewayResponse.builder()
				.setStatusCode(200)
	...
	public static ApiGatewayResponse serverInternalError(Map<String, Object> input) {
		Response responseBody = new Response("Internal Server Error", input);
		return ApiGatewayResponse.builder()
				.setStatusCode(500)
				.setObjectBody(responseBody)
				.setHeaders(Collections.singletonMap("X-Powered-By", "AWS Lambda & Serverless"))
